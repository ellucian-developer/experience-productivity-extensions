...
import { Divider, Illustration, IMAGES, Popper, Typography, Tooltip, TextLink } from '@ellucian/react-design-system/core';
    ...
    if (displayState === 'filesLoaded') {
        ...
        return (
            <div className={classes.card}>
                <Tooltip title={intl.formatMessage({id: 'oneDriveLinkMsg'})}>
                <TextLink className={classes.href} href={intl.formatMessage({id: 'oneDriveURL'})} target='_blank' rel='noreferrer' alt={intl.formatMessage({id: 'oneDriveLinkMsg'})}>
                    <Typography className={classes.fontWeightNormal} variant={'h6'}>
                    {intl.formatMessage({id: 'oneDriveLinkTxt'})}
                    </Typography>
                </TextLink>
                </Tooltip>
